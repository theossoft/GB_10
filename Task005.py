...
j = int(input("Введите номер вагона с начала нумерации: "))

if i != j:
    numbersOfWagon = j + (i-1)
    print(numbersOfWagon)
else:
    print("Без дополнительной информации невозможно определить сколько всего вагонов.")